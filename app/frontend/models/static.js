const api = {
    ...
    "schemas": {
      ...
      "temperature_sensor": {
        "x-rhino-model": {
          ...
          "modelPlural": "temperature_sensors",
          "name": "temperatureSensor",
          "pluralName": "temperatureSensors",
          "readableName": "Temperature sensor",
          "pluralReadableName": "Temperature sensors",
          "ownedBy": "organization",
          "singular": false,
          "path": "/api/temperature_sensors",
          "searchable": false
        },
        "type": "object",
        "properties": {
      ...
      "temperature_reading": {
        "x-rhino-model": {
          ...
          "modelPlural": "temperature_readings",
          "name": "temperatureReading",
          "pluralName": "temperatureReadings",
          "readableName": "Temperature reading",
          "pluralReadableName": "Temperature readings",
          "ownedBy": "temperature_sensor",
          "singular": false,
          "path": "/api/temperature_readings",
          "searchable": false
        },
        "type": "object",
        "properties": {
          ...
          "temperature_sensor": {
            ...
            "anyOf": [
              {
                "$ref": "#/components/schemas/temperature_sensor"
              }
            ]
          }
        },
  ...
  "paths": {
    ...
    "/api/temperature_sensors": {
      "get": {
        "operationId": "temperature_sensor-index",
        "parameters": [
      ...
      "post": {
        "operationId": "temperature_sensor-create",
        "parameters": [
    ...
    "/api/temperature_sensors/:id": {
      "get": {
        "operationId": "temperature_sensor-show",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "patch": {
        "operationId": "temperature_sensor-update",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "delete": {
        "operationId": "temperature_sensor-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/api/temperature_readings": {
      "get": {
        "operationId": "temperature_reading-index",
        "parameters": [
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/temperature_reading"
                }
              }
            }
          },
      ...
      "post": {
        "operationId": "temperature_reading-create",
        "parameters": [
    ...
    "/api/temperature_readings/:id": {
      "get": {
        "operationId": "temperature_reading-show",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "patch": {
        "operationId": "temperature_reading-update",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "delete": {
        "operationId": "temperature_reading-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
